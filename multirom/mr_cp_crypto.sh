...
QCOM_PATH="$1/vendor/lge/hammerhead/qcom/hammerhead/proprietary/"
...
cp -a "$1/vendor/lge/hammerhead/qcom/hammerhead/proprietary/lib/hw/keystore.msm8974.so" "$2/vendor/lib/hw/keystore.default.so"
...
for f in $QCOM_KEYMASTER_FILES; do
    cp -a "$1/vendor/lge/hammerhead/lge/hammerhead/proprietary/${f}" "$2/vendor/firmware/keymaster/"
done
